...
nowhere in a VST2 device, so it has to come from the plugin on disk (see
:func:`harvest_moduleinfo_uids`), from a set that already uses the VST3 (see
:func:`harvest_set_uids`), or from the :data:`KNOWN_TRANSLATIONS` seed table.
"""
